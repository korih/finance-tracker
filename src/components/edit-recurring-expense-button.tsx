...
export function EditRecurringExpenseButton({
  rule,
  spreadsheetId,
}: {
  rule: RecurringRule;
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 pt-2">
          <div className="space-y-1.5">
            <Label htmlFor="ere-merchant">Merchant</Label>
            <Input
              id="ere-merchant"
              name="merchant"
          ...
          <div className="space-y-1.5">
            <Label htmlFor="ere-card">Card</Label>
            <Input
              id="ere-card"
              name="card"
              defaultValue={rule.card ?? ""}
              required
              autoComplete="off"
            />
          </div>
          ...
          <div className="space-y-1.5">
            <Label htmlFor="ere-amount">Amount ($)</Label>
            <Input
              id="ere-amount"
              name="amount"
              type="number"
          ...
          <div className="space-y-1.5">
            <Label htmlFor="ere-recurrence">Recurrence</Label>
            <select
              id="ere-recurrence"
          ...
          {recurrenceType === "custom" && (
            <div className="space-y-1.5">
              <Label htmlFor="ere-days">Every N days</Label>
              <Input
                id="ere-days"
